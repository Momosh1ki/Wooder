(() => {
    ...
    function menuInit() {
        if (document.querySelector(".icon-menu")) document.addEventListener("click", (function(e) {
            if (!isMobile.any()) {
                if (bodyLockStatus && e.target.closest(".icon-menu") || e.target.closest(".menu__text")) {
                    bodyUnlock();
                    document.documentElement.classList.toggle("menu-open");
                }
                if (!document.documentElement.classList.contains("popup-show")) if (bodyLockStatus && !e.target.closest(".menu__body")) {
                    bodyUnlock();
                    document.documentElement.classList.remove("menu-open");
                }
            } else if (bodyLockStatus && e.target.closest(".icon-menu") || e.target.closest(".menu__text")) {
                bodyLockToggle();
                document.documentElement.classList.toggle("menu-open");
            }
        }));
    ...
    function initSliders() {
        if (document.querySelector(".swiper")) new core(".main-slider__slider", {
            ...
            on: {
                slideChange: function(swiper) {
                    const currentSlide = document.querySelector(".main-slider__pagination-numbers");
